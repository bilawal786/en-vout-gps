...
<head>
    ...
    <link rel="stylesheet" href="{{asset('front/css/gredients/purple.css')}}"> <!-- Default color version -->
    <link rel="stylesheet" href="{{asset('front/css/typography/poppins-quciksland.css')}}"> <!-- Default typography version -->
    ...
    <nav class="navbar navbar-inverse navbar-expand-lg header-nav fixed-top light-header">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="/front/img/logo.png" alt=""> <!-- Add your logo here -->
            </a>
    ...
    <div class="container">
        <div class="row full-height align-items-center">
            <div class="col-md-6 p-100px-t p-50px-b md-p-10px-b">
                ...
                <p class="m-25px-b">Abilities or he perfectly pretended so strangers be exquisite. Oh to another chamber pleased imagine do in. Went me rank at last loud shot an draw.
                </p>
            ...
            <div class="col-md-6 p-100px-t p-50px-b md-p-10px-t">
                <img class="hero-mock" src="/front/img/hero-mock.png" alt="Hero mockup"/>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="position-relative md-m-50px-b">
                    ...
                    <img class="moveUpDown" src="/front/img/preface.png" alt="">
                </div>
            </div>
            <div class="col-md-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="position-relative featured-mockup">
                    ...
                    <img class="phone-1" src="/front/img/iphone-1.png" alt="">
                    <img class="phone-2" src="/front/img/iphone-2.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8 offset-lg-2 swiper-container testimonialSwiper p-50px-b">
                <div class="swiper-wrapper">
                    <div class="single-testimonial swiper-slide">
                        <div class="row">
                            <div class="col-lg-2 col-md-3">
                                <img class="rounded-circle" src="/front/img/avater1.jpeg" alt="">
                            </div>
                    ...
                    <div class="single-testimonial swiper-slide">
                        <div class="row">
                            <div class="col-lg-2 col-md-3">
                                <img class="rounded-circle" src="/front/img/avater2.jpeg" alt="">
                            </div>
                            <div class="col-lg-10 col-md-9">
                    ...
                    <div class="single-testimonial swiper-slide">
                        <div class="row">
                            <div class="col-lg-2 col-md-3">
                                <img class="rounded-circle" src="/front/img/avater3.jpeg" alt="">
                            </div>
                            <div class="col-lg-10 col-md-9">
        ...
        <div class="row swiper-container screenshot-swiper p-50px-b">
            <div class="swiper-wrapper">
                <div class="swiper-slide col-sm-4">
                    <img src="/front/img/ss1.png" alt="">
                </div>
                <!-- End single ScreenShot -->
                <div class="swiper-slide col-sm-4">
                    <img src="/front/img/ss2.png" alt="">
                </div>
                <!-- End single ScreenShot -->
                <div class="swiper-slide col-sm-4">
                    <img src="/front/img/ss3.png" alt="">
                </div>
                <!-- End single ScreenShot -->
                <div class="swiper-slide col-sm-4">
                    <img src="/front/img/ss4.png" alt="">
                </div>
                <!-- End single ScreenShot -->
                <div class="swiper-slide col-sm-4">
                    <img src="/front/img/ss5.png" alt="">
                </div>
                <!-- End single ScreenShot -->
            </div>
            <!-- Add Pagination -->
...
<!-- ==========  Screenshots End ========== -->
<!-- ==========  Pricing Start ========== -->
<section id="pricing" class="p-80px-tb parallax bg-overlay opacity-5" style="background-image:url(/front/img/pricing-bg.jpg)">
    <div class="container">
        <div class="row">
            <div class="col-sm-8 offset-sm-2">
                <div class="section-title text-center m-50px-b">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-sm-6 md-m-50px-b">
                <img class="moveUpDown" src="/front/img/experience.png" alt="">
            </div>
            <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="position-relative featured-mockup2">
                    <img class="phone-1" src="/front/img/6mockup1.png" alt="">
                    <img class="phone-2" src="/front/img/6mockup2.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row  justify-content-md-center">
            <div class="col-lg-4 col-md-6">
                <article class="page-content">
                    <div class="blog-post-img">
                        <img src="/front/img/blog/4.jpg" alt="">
                        <div class="blog-tag">
                            <a href="#">Apps UI</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <article class="page-content">
                    <div class="blog-post-img">
                        <img src="/front/img/blog/5.jpeg" alt="">
                        <div class="blog-tag">
                            <a href="#">GooglePlay</a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <article class="page-content">
                    <div class="blog-post-img">
                        <img src="/front/img/blog/1.jpeg" alt="">
                        <div class="blog-tag">
        ...
        <div class="row row-eq-height">
            ...
            <div class="col-lg-8 col-md-6 contact-form p-30px">
                ...
                <form id="contact-form" method="post" action="php/sendmail.php">
                    <div class="message">
                        <p class="email-loading alert alert-warning"><img src="/front/img/loading.gif" alt="">&nbsp;&nbsp;&nbsp;Sending...  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="footer-top text-center p-30px-tb">
                    <a class="footer-logo" href=""><img src="/front/img/logo.png" alt=""></a>
...
<!-- ==========  Footer End ========== -->
<!-- jQuery -->
<script src="{{asset('front/js/jquery-3.2.1.min.j')}}s"></script>
